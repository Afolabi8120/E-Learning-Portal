	...
	<div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="row">
					<?php foreach($user->selectOthers('tbluser','usertype','Lecturer') as $lecturer){ ?>
						...
						<div class="pd-20 card-box height-100-p">
							...
							<div class="profile-social">
								<form action="chat" method="POST">
                                	...
                                	<button type="submit" class="btn-block btn btn-md btn-danger" name="btn-send-msg">Send Message</button>
								</form>
							</div>
                    ...
                    <?php if(!$user->selectOthers('tbluser','usertype','Lecturer')): ?>
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							<h6 class="text-center"><i class="dw dw-sad"></i> Sorry, No Lecturer Available</h6>
						</div>
					</div>
					<?php endif; ?>
				</div>
