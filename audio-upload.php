<?php
    ...
    include('core/validate/audio-upload.php');
        ...
        <div class="pd-ltr-20 xs-pd-20-10 col-md-12 col-sm-12">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-black h4">Uploaded Audio</h4>
					...
					<div class="pb-20">
						<table class="table hover multiple-select-row data-table-export responsive nowrap">
							...
							<tbody>
                                <?php $i = 1; foreach($user->selectFileByType('tblfile','staff_id',$getUserData->userid,'file_type','Audio') as $fetchfile){ ?>
                                <tr>
									...
									<?php if($fetchfile->status == 'Active'): ?>
                                        ...
                                        <td>
                                            <form method="POST">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-warning" onclick="return confirm('Deactivate this Audio?');" name="btn-disable-audio">Disable</button>
                                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Delete this Audio?');" name="btn-delete-audio">Delete</button>
                                            </form>
                                        </td>
                                    <?php elseif($fetchfile->status == 'In-active'): ?>
                                        ...
                                        <td>
                                            <form method="POST">
                                                <input type="hidden" value="<?php echo $fetchfile->id; ?>" name="file_id">
                                                <button type="submit" class="btn btn-sm btn-success" onclick="return confirm('Activate this Audio?');" name="btn-enable-audio">Enable</button>
                                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Delete this Audio?');" name="btn-delete-audio">Delete</button>
                                            </form>
                                        </td>    
                                    <?php endif; ?>
				...
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myLargeModalLabel">Upload Audio</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="course_code" type="text" placeholder="Speech...">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="audio" class="custom-file-input" accept=".mp3, .mp4, .wav">
                                                <label class="custom-file-label">Choose Audio</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
							            ...
							            <button type="submit" class="btn btn-primary" name="btn-save-audio">Save</button>
                                    </div>  
                                </div>
                            </form>
						</div>
